...
const ConferenceAttended = (props) => {
    ...
    useEffect(()=>{
        fetchData.post('user/get/data/conference_attended', {email}).then((res) => {
            setLoading(false)
    ...
    const uploadData = (e) => {
        ...
        const body = {title,venue,start,funding_from,sorting_no
            ,email,name,end,funding_amount}
        setLoading(true)
        fetchData.post('user/upload/data/conference_attended',body).then((res)=>{
    ...
    const Records = ({id,x}) => {
        ...
        const deleteOrUpdateContent = () => {
            ...
            if(mode === editMode) {
                ...
                setLoading(true)
                fetchData.post('user/update/data/conference_attended', {...req_body,start,end,_id: x._id }).then((res) => {
                ...
                fetchData.delete(`user/delete/conference_attended/${x._id}`).then((res) => {
...
export default ConferenceAttended